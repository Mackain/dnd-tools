...
function getDescription(number) {
    const descriptions = {
        ...
        // Dead end (good)
        11: "A battle took place here recently. Bodies lay scattered around the room, and judging from the smell they died just a few days ago.</br></br>[ROLL ON RANDOM ENCOUNTERS TABLE] fought against [ROLL ON RANDOM ENCOUNTERS TABLE], and it looks like there were no survivors. If they choose to loot the bodies they will find:</br>[ROLL ON RANDOM MUNDANE LOOT TABLE 6 TIMES],</br>[ROLL ON THE RANDOM TREASURE TABLE ONCE]",
        ...
        13: "[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br></br>When all party members solve the puzzle, a secret compartment opens in the wall opposite the door. Inside, they will find a small chest.</br>[ROLL ON THE RANDOM TREASURE TABLE ONCE]",
        14: "As you open the door to this room, its weight strikes you by surprise—the backside of this door is heavily reinforced with thick steel, and the walls are thick. This seems to have been some sort of vault or treasury, but its contents have been looted long ago.</br></br>However, careful investigation of the wall finds a hidden mechanism that opens a door to a secret compartment where a chest remains, containing 1d4x100 gold + [ROLL ON THE RANDOM TREASURE TABLE ONCE].</br></br>If the party came here looking for a specific treasure: make it clear to them that this room is NOT their target, and that the real treasure probably still lies somewhere within the dungeon.",
        15: "You enter a small and unremarkable room; it is well protected and would make for a good place to rest a while. On closer inspection, you find a loose stone in the floor hiding a secret!</br>[ROLL ON RANDOM MUNDANE LOOT TABLE 2 TIMES]",
        16: "Stacks of old crates line the walls of this room. Most hold spoiled food, but you think that a thorough investigation may find more interesting things. </br>[ROLL ON RANDOM MUNDANE LOOT TABLE UP TO * NUMBER OF PLAYERS] to determine what they find, depending on how many characters search.",
        17: "A trap has been sprung in this corridor. Long spikes shot out of the wall, killing a poor goblin who stepped on a pressure plate.</br></br>If the party searches the corpse: 1d10 x 10 gold + [ROLL ON RANDOM MUNDANE LOOT TABLE ONCE]",
        ...
        22: "[ROLL ON RANDOM PUZZLE TABLE]</br></br>When all party members are inside the room, the door slams shut behind you, and you hear a locking mechanism engage. </br></br>The door is impossible to unlock and will only open by solving the puzzle.",
        ...
        28: "You enter a large, dark room with sparse furnishings. Someone—or something—was sleeping in one of the dark corners… They awake as you enter.</br>[ROLL ON RANDOM ENCOUNTERS TABLE]",
        ...
        30: "You enter what appears to be some sort of jail. Cells with rusty bars line the sides of this room. There are 5+1d6 goblins in the room. It appears that they are in the middle of fighting over stolen loot.</br>[ROLL ON RANDOM MUNDANE LOOT TABLE 2 TIMES]</br></br>Two goblins are having a fistfight in the middle of the room, and the others are watching and cheering them on. They have not yet noticed you enter.</br>(If you want, you can also put a random NPC in one of the cells for the party to rescue.)",
        // Continue Left
        ...
        32: "You enter a narrow corridor. Along the left wall, you see three doors.</br></br>Door 1 is locked and leads to a small storage room. [ROLL ON RANDOM MUNDANE LOOT TABLE 2 TIMES]</br></br>Door 2 is unlocked and leads to another storage room that contains nothing of value.</br></br>Door 3 is unlocked and leads on to the next room.",
        ...
        38: "You enter a large room, in the middle stands some sort of puzzle.</br>[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br></br>When the puzzle is solved, a secret passage opens in the wall to the left from the direction you entered.",
        ...
        // Continues ahead
        41: "You enter a large circular room with a domed ceiling, at the center you see...</br>[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br>At the far end of the dome, you see another door that looks to be barred with some sort of mechanism.</br></br>The barred door on the other side opens by solving the puzzle. If the players attempt to open the door without solving the puzzle, they can certainly try with a DC of 23.",
        42: "You enter a large chamber; there is not much of note here besides a large iron candelabra that has fallen from the ceiling after its rope gave way.</br></br>On the opposite side of the room, you see another door, slightly ajar. As you near the center of the room, you hear noises coming from beyond the ajar door.</br></br>The door is slowly pushed aside as someone or something enters the room.</br>[ROLL ON RANDOM ENCOUNTERS TABLE]",
        ...
        46: "You enter a large hexagonal room; at its center, you see...</br>[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br></br>At the far end of the dome, you see another door.</br></br>The door in the other end of the room is unlocked, and the party can simply continue through to the next room if they want to.</br></br>If they choose to solve the puzzle, the puzzle will instead unlock a trapdoor in the floor that will reveal a treasure chest with silver bars that are worth 1d4x100 gold.",
        47: "You enter a dark corridor that leads to a door straight ahead of you.</br>You hear movement in the darkness…</br></br>[ROLL ON RANDOM ENCOUNTERS TABLE]",
        48: "This small room is lit by two small braziers, filled with glowing embers.</br>At the other end of the room, you see…</br></br>[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br></br>Solving the puzzle will make it magically disappear, revealing a door.",
        ...
        53: "You enter a circular room, its walls covered in shelves with books. There is another door to your right.</br>In the center of the room stands a raised platform, and at its center mounted to the floor is a large telescope pointed at the ceiling.</br></br>If the players explore the bookshelves, they will find that they are all notebooks on astrology. As they go on, they get more and more deranged, and by the end they are just mad ramblings about the stars not being right. There are also various items scattered among the shelves.</br>[ROLL ON RANDOM MUNDANE LOOT TABLE 2 TIMES]</br></br>If the players look through the telescope, they will see a clear night sky. The stars and moon indicate that what they are seeing is the current sky above the dungeon. The telescope always works despite the time of day or weather conditions, and it always gets a clear view of the stars above. The telescope is mounted fast to the platform and cannot be removed without risking damaging it.</br></br>If the players try to use the telescope to see through walls of the dungeon, they will find that the telescope cannot be tilted down beyond a 45-degree angle; it is always pointed upwards towards the ceiling. It can swivel and look at any point of the ceiling but cannot be tilted down from it.",
        54: "You enter a long corridor. There are two doors to your left and three to your right.</br></br>1st door left does not move. The room beyond has caved in, and huge boulders are pressing against the door, keeping it shut.</br></br>2nd door left: If you enter this door, you come out through the 1st door to the right unless the spell is broken. If the spell is broken, this just becomes a small storage unit with little of value.</br></br>1st door right: If you enter this door, you come out through the 2nd door to the left unless the spell is broken. If the spell is broken, this becomes a small room with a hidden treasure containing 200 gold + [ROLL ON THE RANDOM TREASURE TABLE ONCE]!</br></br>2nd door right continues on to the next part of the dungeon.</br></br>3rd door right leads to a small room that is completely caved in.",
        ...
        60: "You enter what appears to be a dead-end. A large octagonal room with bare stone walls. In the center of the room, you see...</br>[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br></br>Solving the puzzle will make a door magically appear in the wall to the right.",
        ...
        85: "You enter a circular room, and in the middle of the room, you see...</br>[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br></br>Across on the other side of the room, you see an alcove where a statue of a jester smiles at you. Perceptive players may notice that the alcove across on the other side of the room and the door that they just entered both have the exact same archway around them.</br></br>Solving the puzzle will cause the walls of the room to rotate clockwise 90 degrees. This will make the alcove and the door that the party entered through inaccessible, but reveal two new doors to the left and right. The puzzle will then reset, and for every time the puzzle is solved, the process repeats and the walls rotate 90 degrees.",
        ...
        94: "You enter a large room, and at its center, you see...</br>[ROLL ON THE RANDOM PUZZLE TABLE ONCE]</br></br>Across on the other side of the room, you see a steel door that is barred with a sturdy mechanism. There are also two other doors on either side of the room, to your left and right, but these are not barred as far as you can see.</br></br>Solving the puzzle will trigger the mechanism that is barring the steel door. Both of the other doors to the sides are locked, but easily picked (DC 12).",
